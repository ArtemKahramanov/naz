...
<div class="tab-content" id="nav-tabContent">
    ...
    <?php if ($iconsList == 'text' || $iconsList == 'none'): ?>
        <?php if ($showIDAttribute && $showNameAttribute): ?>
            <div class="row">
                ...
                <div class="col-sm-12">
                    <?= $form->field($node, 'description')->widget(\yii\redactor\widgets\Redactor::className()) ?>
                </div>
            </div>
        <?php else: ?>
            <?= $keyField ?>
    ...
    <?php if ($isAdmin): ?>
        ...
        <div class="row mb">
            ...
            <div class="col-sm-3">
                <?= $form->field($node, 'sort')->textInput(['type' => 'number', 'min' =>1]) ?>
            </div>
        </div>
        ...
        <div class="row align-center mb">
            ...
            <div class="col-sm-6 block-image">
                <?php if (!empty($node->photo)): ?>
                    <?php $path = Yii::getAlias('/img/admin/') . $node->photo; ?>
